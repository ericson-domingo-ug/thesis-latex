\section{Hindcast Results}
	\subsection{Model Evaluation}
		...
		One reason why this may be the case is because of the elevation of the city.
		Baguio is situated about 1,500 m above sea level, unlike the other cities which are situated near sea level.
		Another reason could be the nearby topology of Baguio.
		While other cities have roughly the same elevation in its surroundings, Baguio’s surroundings have varying elevation, which can affect the simulation.
