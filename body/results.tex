\section{Model Evaluation}
	...
	\begin{table}[]
		\caption{Evaluation results for the three cities outside Metro Manila. Values that do not match the recommended values are colored in red.}
	...
	Most runs improve accuracy when switching from a lower resolution to a higher resolution.
...
\section{Hindcast and Forecast Analysis}
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/yearly-mean}
		\includegraphics[width= 0.49 \textwidth]{forecast/yearly-mean}
		\caption{
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/yearly-boxplot-pasay}
		\includegraphics[width= 0.49 \textwidth]{forecast/yearly-boxplot-pasay}
		\includegraphics[width= 0.49 \textwidth]{hindcast/yearly-boxplot-quezon}
		\includegraphics[width= 0.49 \textwidth]{forecast/yearly-boxplot-quezon}			
		\includegraphics[width= 0.49 \textwidth]{hindcast/yearly-boxplot-manila}
		\includegraphics[width= 0.49 \textwidth]{forecast/yearly-boxplot-manila}			
		\caption{
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/yearly-boxplot-angeles}
		\includegraphics[width= 0.49 \textwidth]{forecast/yearly-boxplot-angeles}
		\includegraphics[width= 0.49 \textwidth]{hindcast/yearly-boxplot-baguio}
		\includegraphics[width= 0.49 \textwidth]{forecast/yearly-boxplot-baguio}		
		\caption{
...
%		\end{figure}
	...
	\begin{figure}	
		...
		\includegraphics[width = \textwidth]{forecast/monthly-mean}
		\caption{
...
%		\end{figure}
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/hourly-mean-djf}		
		\includegraphics[width= 0.49 \textwidth]{forecast/hourly-mean-djf}		
		\caption{
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/hourly-mean-mam}		
		\includegraphics[width= 0.49 \textwidth]{forecast/hourly-mean-mam}		
		\caption{
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/hourly-mean-jja}		
		\includegraphics[width= 0.49 \textwidth]{forecast/hourly-mean-jja}		
		\caption{
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/hourly-mean-son}		
		\includegraphics[width= 0.49 \textwidth]{forecast/hourly-mean-son}		
		\caption{
...
%	\begin{table}[]
%		\caption{Mean urban heat island intensity}
%		\label{tab:UHII}
%		\centering
%		\begin{tabular}{llll}
%			\hline \hline
%			& 2013-2018 & 2027-2031 & Increase \\
%			\hline
%			PASAY   & 1.75      & 1.82      & 0.07     \\
%			QUEZON  & 0.80      & 0.89      & 0.08     \\
%			MANILA  & 1.72      & 1.85      & 0.13     \\
%			ANGELES & 1.31      & 1.33      & 0.02     \\			
%			BAGUIO  & 0.13      & 0.01      & -0.12   \\
%			\hline
%		\end{tabular}
%	\end{table}
	...
	\begin{figure}	
		\centering
		\includegraphics[width= 0.49 \textwidth]{hindcast/uhii-boxplot}		
		\includegraphics[width= 0.49 \textwidth]{forecast/uhii-boxplot}		
		\caption{
...
\section{SARIMA}
	...
	\begin{table}[]
		...
		\begin{tabular}{lSSSS}
			\hline \hline
			& \multicolumn{2}{c}{(Original)} & \multicolumn{2}{c}{(First-order difference)} \\
	...
	\begin{figure}
		\centering
		\includegraphics[width=\textwidth]{SARIMA/autocorrelations-first-order}
		\caption{
...
\section{Discussion}
	...
	\begin{figure}	
		\centering
		\includegraphics[width = \textwidth]{google-maps-olongapo}
		\caption{
			A closer look at Olongapo. Weather station marked with pin. Taken from Google Maps.
		}
		\label{fig:google-maps-olongapo}
	\end{figure}
	...
	However, the EIN15 runs for Olongapo are different, wherein using a finer resolution made the model less accurate.
	This does not happen with the Olongapo CNRM-CM5 runs; using a finer resolution made the model more accurate.
	One possible reason for this may be because of the station being situated by a bay (Figure \ref{fig:google-maps-olongapo}).
	...
	Another possible reason for this is the limitation of this study that the analysis is limited by the sampling of the weather stations.
	The coordinates of the weather station may not correspond exactly to the coordinates of the grid points, which may affect the reading for Olongapo.
	Verifying these conjectures are outside the scope of this study.		
