\section{Hindcast Results}
	...
	\subsection{Analysis}
		...
		\begin{table}[]
			\caption{
				Mean simulated near-surface air temperature per season at 6 AM (Day), 6 PM (Night), and their difference (Diff.).
			}
			...
			\begin{tabular}{lSSSSS}
				...
				Diff. & 4.4   & 4.9    & 4.5    & 5.9     & 5.2   			\end{tabular}
		\end{table}
		...
		Pasay and Manila have the least difference between day and night temperature, while Angeles shows the greatest difference.
